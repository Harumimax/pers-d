...
return [
    'hero' => [
        ...
        'description_2' => 'Right now the site already supports the core product loop: authenticated users can create personal dictionaries, add words manually or through assisted translation, assign part of speech, keep comments, launch Remainder practice sessions, work with prepared dictionaries, and use the interface in Russian or English. The current focus is polishing the existing learning workflow, expanding prepared dictionary content, and improving future delivery channels such as Telegram-based practice.',
    ],
    'contact' => [
        'title' => 'Contact form',
