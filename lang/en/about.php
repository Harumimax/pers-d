...
return [
    'hero' => [
        ...
        'description_2' => 'Right now the site already supports the full core loop: authenticated users can create personal dictionaries, add words manually or through assisted translation, assign part of speech, keep comments, and quickly search, sort, and filter entries inside each dictionary. The next product step is turning stored vocabulary into active practice, starting with a dedicated repetition mode for words.',
    ],
    'contact' => [
        'title' => 'Contact form',
    ...
    'status' => [
        ...
        'items' => [
            ...
            'placeholder_language_switcher' => 'Add a placeholder interface language switcher in the site header',
            ...
            'real_localization' => 'Add real interface localization for Russian and English',
