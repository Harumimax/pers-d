<main class="dictionaries-main dictionary-show-main">
    <section class="dictionaries-container dictionary-show">
        ...
        <header class="dictionary-show__header dictionary-show-hero">
            <div class="dictionary-show-hero__content">
                <a href="{{ route('ready-dictionaries-v2.index') }}" class="dictionary-show-hero__back-link">
                    &larr; {{ __('common.links.ready_dictionaries') }}
                </a>

                <p class="dictionary-show-hero__eyebrow">
                    {{ __('common.links.ready_dictionaries') }}
                </p>

                <h1 class="dictionary-show-hero__title">
                    {{ $readyDictionary->name }}
                </h1>

                <p class="dictionary-show-hero__subtitle">
                    {!! __('ready_dictionaries.show.subtitle', [
                        'language' => '<b>' . e($dictionaryLanguageLabel) . '</b>',
                        'count' => '<b>' . e($totalWordsCount) . '</b>',
                        'date' => '<b>' . e($createdDateLabel) . '</b>',
                    ]) !!}
                </p>

                <div class="dictionary-show-hero__pills">
                    <span class="dictionary-show-hero__pill">&#128218; {{ $dictionaryLanguageLabel }}</span>
                    <span class="dictionary-show-hero__pill">&#128221; {{ $totalWordsCount }} words</span>
                    <span class="dictionary-show-hero__pill">&#128264; Pronunciation ready</span>
                </div>
            </div>

            <div class="dictionary-show-hero__visual" aria-hidden="true">
                <div class="dictionary-show-hero__mini-card dictionary-show-hero__mini-card--main">
                    <span>Practice-ready set</span>
                    <strong>{{ $totalWordsCount }}</strong>
                    <small>words available</small>
                </div>

                <div class="dictionary-show-hero__mini-card dictionary-show-hero__mini-card--floating">
                    <span>Search</span>
                    <strong>Filter</strong>
                    <small>Review faster</small>
                </div>
            </div>
        </header>
                                ...
                                <tr wire:key="ready-word-row-{{ $wordItem->id }}">
                                    ...
                                    <td class="word-list-pronounce-cell">
                                        @if ($pronounceLocale !== null)
                                            ...
                                            >
                                                <span class="word-list-pronounce-btn__icon" aria-hidden="true">рџ”Љ</span>
                                            </button>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td class="word-list-action-cell">
                                        <div class="word-list-actions">
                                            @auth
                                                ...
                                                >
                                                    <span aria-hidden="true">{{ ($favoriteWordMap[$wordItem->id] ?? false) ? 'в…' : 'в†' }}</span>
                                                </button>
                                            @endauth
