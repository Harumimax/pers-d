...
class TelegramRunConflictResolverService
{
    ...
    private function notifyUserAboutExpiredRuns(User $user, int $expiredRunsCount): void
    {
        ...
        $text = $expiredRunsCount === 1
            ? 'Одна из прошлых сессий не была завершена, поэтому вместо неё началась новая.'
            : 'Несколько прошлых сессий не были завершены, поэтому вместо них началась новая.';
